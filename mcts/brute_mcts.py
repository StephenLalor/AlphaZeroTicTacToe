...
class BruteMCSTNode:
    ...
    def __init__(self, parent: "BruteMCSTNode", board: TicTacToeBoard, opts: dict):
        self.parent = parent
        self.children = []
        self.opt_child = None
        self.board = board
    ...
    def calc_utc_score(self, child: "BruteMCSTNode", c: float) -> float:
        """
    ...
    def get_best_child(self, c: float) -> "BruteMCSTNode":
        """
    ...
    def expand(self) -> "BruteMCSTNode":
        ...
        child = BruteMCSTNode(self, new_board, self.opts)
    ...
    def get_reward(self, node: "BruteMCSTNode", game_result: TicTacToeBot | str) -> float:
        """
